...
import { requireFirebaseUser, verifyMercadoPagoWebhook, recordWebhookIdempotency, requireMercadoPagoCredential, enforceServerPrice, rejectSimulatedPreferenceResponse, verifyPaymentAgainstMercadoPago, rejectUnimplementedCancellation, calculateCouponPrice, resolveCanonicalBasePrice } from './mercadopago-security.ts';
...
const unitEconomicsData:UnitEconomics={arpuUsd:2.34,cacUsd:12.5,paybackMonths:5.5,churnRatePct:2.1,ltvUsd:108.08,contributionMarginPct:97.3,ltvToCacRatio:8.6,isHealthy:true};
const anomalyDetections:AnomalyItem[]=[
{id:'anom_01',detectedAt:new Date(Date.now()-3600000*2).toISOString(),type:'IA_SPIKE',severity:'MEDIA',title:'Pico Inesperado de Consultas en Scout IA (+145%)',metricVariation:'+145% llamadas a Gemini Flash en 2h',aiCauseExplanation:'Varias agencias realizaron búsquedas simultáneas de planteles juveniles usando filtros complejos.',mitigationApplied:'Caché semántica activada automáticamente para consultas repetidas de scouting.'},
{id:'anom_02',detectedAt:new Date(Date.now()-3600000*14).toISOString(),type:'FIRESTORE_READ_SPIKE',severity:'ALTA',title:'Aumento de Lecturas Firestore en Smart Feed (+210%)',metricVariation:'+210% lecturas sin paginado en Feed Público',aiCauseExplanation:'Navegación de usuarios no autenticados consumiendo publicaciones sin restricción de límite.',mitigationApplied:'Paginación estricta a limit(15) forzada en servidor express.'},
{id:'anom_03',detectedAt:new Date(Date.now()-3600000*36).toISOString(),type:'STORAGE_GROWTH',severity:'BAJA',title:'Crecimiento de Almacenamiento Multimedia HD (+3.2 GB)',metricVariation:'+3.2 GB en Firebase Storage en 24h',aiCauseExplanation:'Carga masiva de videos de jugadas destacadas por futbolistas verificados.',mitigationApplied:'Compresión WebP y transcodificación H.264 automática activada en subidas.'}];
const actionableRecommendations:ActionableRecommendation[]=[
{id:'rec_01',category:'IA_LIMITS',title:'Aumentar Límite Diario de Consultas IA en Coach Deportivo',impactEstimate:'+14% Retención | +$0.40 USD/mes costo',description:'Dado que el módulo Coach IA opera con un margen del 98%, elevar el límite diario de 20 a 35 consultas aumentará el engagement sin afectar las finanzas.',recommendedAction:'Aumentar el límite de consultas de IA para usuarios PRO.'},
{id:'rec_02',category:'PRECIOS',title:'Ajuste del Plan Premium Atleta de $14.900 a $18.500 ARS',impactEstimate:'+24% Incremento MRR (+~$105 USD/mes)',description:'El valor percibido por la plataforma permite un incremento del 24% sin disparar la tasa de Churn.',recommendedAction:'Actualizar el precio del Plan Premium en la pasarela de pagos.'},
{id:'rec_03',category:'COST_OPTIMIZATION',title:'Optimización de Exportación PDF HD para Eliminar Déficit',impactEstimate:'Ahorro de $0.80 USD/mes | Margen positivo',description:'El módulo de PDF genera $5.80 USD de costo y $5.00 USD de ingreso. Aplicando compresión vectorial de imágenes en servidor se elimina el déficit.',recommendedAction:'Activar compresión de imágenes en generación de PDF.'},
{id:'rec_04',category:'MARKETING',title:'Aumentar Inversión en Marketing de Adquisición',impactEstimate:'Retorno Estimado LTV/CAC: 8.6x',description:'El costo de adquisición ($12.50 USD) se recupera en solo 5.5 meses con un LTV de $108.08 USD, lo que justifica escalar pauta en redes sociales.',recommendedAction:'Duplicar presupuesto de adquisición enfocado en Clubes y Agentes.'}];
const businessHealthScore:BusinessHealthScore={overallScore:95,status:'EXCELENTE',components:{security:98,availability:99,profitability:97,growth:88,costControl:95,userSatisfaction:92,performance:94},summaryText:'La plataforma TalentMatch / ScoutAR se encuentra en estado EXCELENTE. Operación 100% autosostenible con margen bruto del 97% y cero riesgo financiero.'};
...
const budgetConfig:BudgetConfig={monthlyBudgetUsd:50,dailyBudgetUsd:2.5,aiBudgetUsd:30,firestoreBudgetUsd:10,storageBudgetUsd:5,cloudRunBudgetUsd:5,freeUserDailyAiLimit:5,premiumUserDailyAiLimit:100,freeUserMonthlyAppLimit:20};
const reserveFundConfig:ReserveFundConfig={operationPct:70,growthPct:20,emergencyPct:10,operationalPoolUsd:304.85,growthPoolUsd:87.1,emergencyPoolUsd:43.55};
const featureProfitabilityData:FeatureProfitability[]=[
{id:'scout_ia',name:'Scout IA (Recomendador de Candidatos)',activeUsers:85,revenueUsd:185,revenueArs:240500,totalCostUsd:3.8,aiCostUsd:3.1,firestoreCostUsd:.4,storageCostUsd:0,cloudRunCostUsd:.3,netProfitUsd:181.2,profitMarginPct:97.9,growthTrend:'+18% (Alta Rentabilidad)',isDeficit:false,status:'PROFITABLE'},
{id:'coach_ia',name:'Coach Deportivo IA & Planes',activeUsers:62,revenueUsd:120,revenueArs:156000,totalCostUsd:2.4,aiCostUsd:1.9,firestoreCostUsd:.3,storageCostUsd:0,cloudRunCostUsd:.2,netProfitUsd:117.6,profitMarginPct:98,growthTrend:'+12%',isDeficit:false,status:'PROFITABLE'},
{id:'smart_feed',name:'Smart Feed Social & Videos',activeUsers:148,revenueUsd:60,revenueArs:78000,totalCostUsd:1.85,aiCostUsd:0,firestoreCostUsd:1.2,storageCostUsd:.45,cloudRunCostUsd:.2,netProfitUsd:58.15,profitMarginPct:96.9,growthTrend:'+5%',isDeficit:false,status:'PROFITABLE'},
{id:'chat_directo',name:'Chat Directo & Negociaciones',activeUsers:90,revenueUsd:40,revenueArs:52000,totalCostUsd:.9,aiCostUsd:0,firestoreCostUsd:.7,storageCostUsd:.2,cloudRunCostUsd:0,netProfitUsd:39.1,profitMarginPct:97.8,growthTrend:'+8%',isDeficit:false,status:'PROFITABLE'},
{id:'comparador_jugadores',name:'Comparador de Jugadores Head-to-Head',activeUsers:42,revenueUsd:25,revenueArs:32500,totalCostUsd:.65,aiCostUsd:.5,firestoreCostUsd:.15,storageCostUsd:0,cloudRunCostUsd:0,netProfitUsd:24.35,profitMarginPct:97.4,growthTrend:'+14%',isDeficit:false,status:'PROFITABLE'},
{id:'radar_talentos',name:'Radar de Talentos & Filtros Avanzados',activeUsers:55,revenueUsd:30,revenueArs:39000,totalCostUsd:.8,aiCostUsd:.6,firestoreCostUsd:.2,storageCostUsd:0,cloudRunCostUsd:0,netProfitUsd:29.2,profitMarginPct:97.3,growthTrend:'+10%',isDeficit:false,status:'PROFITABLE'},
{id:'reportes_pdf',name:'Exportación de Reportes PDF HD',activeUsers:18,revenueUsd:5,revenueArs:6500,totalCostUsd:5.8,aiCostUsd:0,firestoreCostUsd:.8,storageCostUsd:4,cloudRunCostUsd:1,netProfitUsd:-.8,profitMarginPct:-16,growthTrend:'-4% (En Déficit)',isDeficit:true,status:'DEFICIT'},
{id:'notificaciones_alertas',name:'Notificaciones & Alertas Email/Push',activeUsers:148,revenueUsd:0,revenueArs:0,totalCostUsd:.45,aiCostUsd:0,firestoreCostUsd:.2,storageCostUsd:0,cloudRunCostUsd:.25,netProfitUsd:-.45,profitMarginPct:0,growthTrend:'Estable (Soporte Base)',isDeficit:false,status:'SUPPORT_COST'}];
const financialAlerts:FinancialAlert[]=[
{id:'alert_001',timestamp:new Date(Date.now()-3600000*3).toISOString(),priority:'ALTA',title:'Funcionalidad en Déficit: Exportación PDF HD',description:'La generación de reportes PDF HD generó $5.80 USD de costo frente a solo $5.00 USD de ingresos atribuibles.',suggestedAction:'Aplicar compresión server-side de imágenes en los PDF o limitar a usuarios Plan PRO.'},
{id:'alert_002',timestamp:new Date(Date.now()-3600000*8).toISOString(),priority:'MEDIA',title:'Pico de Lecturas Firestore en Smart Feed',description:'Se detectó un aumento del 12% en lecturas no paginadas en Smart Feed por usuarios no autenticados.',suggestedAction:'Forzar paginación estricta a limit(15) en feed público para ahorrar ~$0.80 USD/mes.'},
{id:'alert_003',timestamp:new Date(Date.now()-3600000*24).toISOString(),priority:'BAJA',title:'Fondo de Emergencia Asignado Exitosamente',description:'Se ha reservado un 10% del MRR ($43.55 USD) en la subcuenta intocable de emergencia.',suggestedAction:'Ninguna acción requerida. Fondo protegido.'}];
const financialState:any={incomeMonthlyArs:566200,incomeMonthlyUsd:435.5,currentMonthSpendUsd:{ai:6.4,firestore:2.15,storage:.8,cloudRun:1.2,hosting:.5,notificationsEmail:.45,total:11.5},todaySpendUsd:{ai:.35,firestore:.12,storage:.04,cloudRun:.08,hosting:.02,notificationsEmail:.01,total:.62},totalsCounters:{aiCallsMonth:1240,aiTokensMonth:215000,firestoreReadsMonth:45200,firestoreWritesMonth:6800,storageBytesMonth:8.4*1024*1024*1024,activeFreeUsers:110,activePremiumUsers:38}};
const userCostMap=new Map<string,UserCostRecord>();
const seedUserStats:UserCostRecord[]=[
{userId:'usr_001',userEmail:'demo.club001@synthetic.invalid',role:'club',isPremium:true,aiCallsToday:18,aiCallsTotal:142,firestoreReads:1250,firestoreWrites:140,estimatedCostUsd:1.15,revenueGeneratedArs:49900,netProfitUsd:37.23,isDeficit:false,lastActive:'Hace 5 min'},
{userId:'usr_002',userEmail:'demo.athlete002@synthetic.invalid',role:'atleta',isPremium:false,aiCallsToday:5,aiCallsTotal:48,firestoreReads:620,firestoreWrites:45,estimatedCostUsd:.38,revenueGeneratedArs:0,netProfitUsd:-.38,isDeficit:true,lastActive:'Hace 12 min'},
{userId:'usr_003',userEmail:'demo.club003@synthetic.invalid',role:'club',isPremium:true,aiCallsToday:24,aiCallsTotal:210,firestoreReads:2400,firestoreWrites:310,estimatedCostUsd:1.85,revenueGeneratedArs:49900,netProfitUsd:36.53,isDeficit:false,lastActive:'Hace 2 min'},
{userId:'usr_004',userEmail:'demo.athlete004@synthetic.invalid',role:'atleta',isPremium:true,aiCallsToday:12,aiCallsTotal:86,firestoreReads:890,firestoreWrites:80,estimatedCostUsd:.72,revenueGeneratedArs:14900,netProfitUsd:10.74,isDeficit:false,lastActive:'Hace 45 min'},
{userId:'usr_005',userEmail:'demo.athlete005@synthetic.invalid',role:'atleta',isPremium:false,aiCallsToday:5,aiCallsTotal:120,firestoreReads:3100,firestoreWrites:190,estimatedCostUsd:1.45,revenueGeneratedArs:0,netProfitUsd:-1.45,isDeficit:true,lastActive:'Hace 1 hora'}];
seedUserStats.forEach(u=>userCostMap.set(u.userId,u));
const financialAuditLogs:FinancialAuditLog[]=[{id:'flog_101',timestamp:new Date(Date.now()-3600000*2).toISOString(),action:'REUTILIZACIÓN_DE_CACHÉ_IA',reason:'Consulta idéntica detectada para recomendación de candidatos en Santiago del Estero.',estimatedSavingsUsd:.0035,protectionLevel:'NORMAL'},{id:'flog_102',timestamp:new Date(Date.now()-3600000*5).toISOString(),action:'PAGINACIÓN_FIRME_FIRESTORE',reason:'Filtro aplicado en servidor con limit(20) reduciendo 850 lecturas innecesarias.',estimatedSavingsUsd:.0012,protectionLevel:'NORMAL'},{id:'flog_103',timestamp:new Date(Date.now()-3600000*12).toISOString(),action:'OPTIMIZACIÓN_DE_TOKENS_IA',reason:'Recorte automático de array de candidatos a 30 ítems para reducir consumo de tokens en Gemini.',estimatedSavingsUsd:.008,protectionLevel:'OPTIMIZING_75'}];
function getProtectionStatus(){const currentTotal=financialState.currentMonthSpendUsd.total;const budget=budgetConfig.monthlyBudgetUsd;const pct=Math.min(100,Math.round(currentTotal/budget*100));let status:'NORMAL'|'WARNING_50'|'OPTIMIZING_75'|'THROTTLING_90'|'PROTECTION_MODE_100'='NORMAL';if(pct>=100)status='PROTECTION_MODE_100';else if(pct>=90)status='THROTTLING_90';else if(pct>=75)status='OPTIMIZING_75';else if(pct>=50)status='WARNING_50';return{percentageSpent:pct,status,currentSpendUsd:currentTotal,budgetUsd:budget};}
...
function trackUserUsage(userId:string,userEmail?:string,role?:string,isPremium?:boolean,costUsd=.0025,aiCalls=1,reads=0,writes=0){const uid=userId||'usr_anonymous';const existing=userCostMap.get(uid)||{userId:uid,userEmail:userEmail||`user_${uid.slice(0,6)}@talentmatch.ar`,role:role||'atleta',isPremium:!!isPremium,aiCallsToday:0,aiCallsTotal:0,firestoreReads:0,firestoreWrites:0,estimatedCostUsd:0,revenueGeneratedArs:isPremium?14900:0,netProfitUsd:isPremium?11.46:0,isDeficit:false,lastActive:'Ahora mismo'};existing.aiCallsToday+=aiCalls;existing.aiCallsTotal+=aiCalls;existing.firestoreReads+=reads;existing.firestoreWrites+=writes;existing.estimatedCostUsd=parseFloat((existing.estimatedCostUsd+costUsd).toFixed(4));existing.netProfitUsd=parseFloat(((existing.revenueGeneratedArs/1300)-existing.estimatedCostUsd).toFixed(2));existing.isDeficit=existing.netProfitUsd<0;existing.lastActive='Ahora mismo';userCostMap.set(uid,existing);financialState.currentMonthSpendUsd.ai+=costUsd;financialState.currentMonthSpendUsd.total+=costUsd;financialState.todaySpendUsd.ai+=costUsd;financialState.todaySpendUsd.total+=costUsd;financialState.totalsCounters.aiCallsMonth+=aiCalls;}
